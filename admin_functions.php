...
function template_header( $title ) {
	$username          = isset( $_SESSION['username'] ) ? $_SESSION['username'] : ''; // New line to get username
	echo <<<EOT
				...
				<div id="registrationOverlay" class="overlay-container" > 
					<div class="popup-box"> 
						...
						<form id="registrationForm" class="form-container" action="register.php" method="post" onsubmit="return validateregisterForm()">
							...
							<input class="form-input" type="tel" placeholder="Enter Your Username"	id="mobile" name="mobile"> 

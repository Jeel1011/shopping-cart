...
// If the user clicked the "Place Order" button
				...
				<tr>
					<td class="img">
						<a href="index.php?page=product&id=<?php echo $product['id']; ?>">
							<img src="imgs/<?php echo $product['img']; ?>" width="50" height="50" alt="<?php echo $product['name']; ?>">
						</a>
					</td>
					<td>
						<a href="index.php?page=product&id=<?php echo $product['id']; ?>"><?php echo $product['name']; ?></a>
						<br>
						<a href="index.php?page=cart&remove=<?php echo $product['id']; ?>" class="remove">Remove</a>
					</td>
